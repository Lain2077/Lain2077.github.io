(function () {
    ...
    function k(b, c) {
        ...
        function T() {
            f.buttons &&
                (n.after("<div class='ism-button ism-button-prev'>&nbsp;</div><div class='ism-button ism-button-next'>&nbsp;</div>"),
            ...
            if (f.radios) {
                ...
                for (var a = 0; a < m(); a++)
                    0 == a
                        ...
                        : z.append("<li class='ism-radio-" + a + "'><input type='radio' name='ism-radio' class='ism-radio' id='ism-radio-" + a + "' /><label class='ism-radio-label' for='ism-radio-" + a + "'></label></li>");
        ...
        function O(a) {
            W();
            "none" != f.image_fx &&
                ("zoompan" == f.image_fx ? d("#" + b + " .ism-slide-" + a + " .ism-img-frame").addClass("ism-zoom-pan") : "zoomrotate" == f.image_fx && d("#" + b + " .ism-slide-" + a + " .ism-img-frame").addClass("ism-zoom-rotate"));
        }
        function W() {
...
(function (e, d) {
    ...
    d.prototype = {
        defaults: { disabled: !1, horizontal: !0, vertical: !1, slide: !0, steps: 0, snap: !1, loose: !1, speed: 0.1, xPrecision: 0, yPrecision: 0, activeClass: "active", css3: !0, tapping: !0, afterSwipeCallback: function () {} },
        init: function () {
        ...
        startTap: function () {
            !this.disabled &&
                ...
                ((this.tapping = !0), this.setWrapperOffset(), this.setTargetValueByOffset([h.x - this.offset.wrapper[0] - this.handle.offsetWidth / 2, h.y - this.offset.wrapper[1] - this.handle.offsetHeight / 2]));
        },
        stopTap: function () {
        ...
        glide: function () {
            ...
            if (!a[0] && !a[1]) return !1;
            Math.abs(a[0]) > this.valuePrecision[0] || Math.abs(a[1]) > this.valuePrecision[1]
                ? ((this.value.current[0] += a[0] * Math.min((this.options.speed * this.timeOffset) / 25, 1)), (this.value.current[1] += a[1] * Math.min((this.options.speed * this.timeOffset) / 25, 1)))
        ...
        animateSlide: function () {
            for (
                var a = this.value.target[0] - this.value.current[0],
                    b = 0 <= a ? 1 : -1,
                    a = Math.abs(a),
                    c = (this.value.current[0] - this.slide_start) / (this.value.target[0] - this.slide_start),
                    d = c - 0.5,
                ...
                d *= 0.5;
            0.995 < c ? (this.groupCopy(this.value.current, this.value.target), (this.sliding = !1), this.slide_callback()) : (this.value.current[0] += b * d);
            this.updateOffsetFromValue();
        ...
        renderHandlePosition: function () {
            ...
            this.options.css3 && r.transform
                ? (this.options.horizontal && (a += "translateX(" + this.offset.current[0] + "px)"), (this.handle.style[r.transform] = a))
    ...
    for (
        var k = function (a, b) {
            ...
            r = { transform: e("transform"), perspective: e("perspective"), backfaceVisibility: e("backfaceVisibility") },
            u = ["webkit", "moz"],
        ...
        (m = window[u[v] + "RequestAnimationFrame"]), (x = window[u[v] + "CancelAnimationFrame"] || window[u[v] + "CancelRequestAnimationFrame"]);
    m ||
        ((m = function (a) {
