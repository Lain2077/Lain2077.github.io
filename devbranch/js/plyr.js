            ...
            createRange: function (e, t) {
                var n = me(
                    ...
                    ue(
                        ...
                        { type: "range", min: 0, max: 100, step: 0.01, value: 0, autocomplete: "off", role: "slider", "aria-label": $e(e, this.config), "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": 0 },
                        t
                    )
                );
                    ...
                    function (i) {
                        if ([32, 38, 39, 40].includes(i.which) && (i.preventDefault(), i.stopPropagation(), "keydown" !== i.type)) {
                            ...
                            if (!r && [32, 39].includes(i.which)) at.showMenuPanel.call(n, t, !0);
                                ...
                                32 !== i.which &&
                                    (40 === i.which || (r && 39 === i.which) ? ((a = e.nextElementSibling), Z(a) || (a = e.parentNode.firstElementChild)) : ((a = e.previousElementSibling), Z(a) || (a = e.parentNode.lastElementChild)),
                                    Se.call(n, a, !0));
                        }
                    },
                    !1
                ...
                if (Z(this.elements.settings.panels.captions)) {
                    ...
                    if ((at.toggleMenuButton.call(this, t, a), ge(n), at.checkMenu.call(this), a)) {
                        var r = i.map(function (t, i) {
                            return { value: i, checked: e.captions.toggled && e.currentTrack === i, title: st.getLabel.call(e, t), badge: t.language && at.createBadge.call(e, t.language.toUpperCase()), list: n, type: "language" };
                        });
                                        ...
                                        if (((l = this.media.querySelector("iframe")), Z(l))) {
                                            if (
                                                ...
                                                u.includes(c.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                                                    ...
                                                    this.isYouTube ? ((this.config.playsinline = u.includes(c.searchParams.get("playsinline"))), (this.config.youtube.hl = c.searchParams.get("hl"))) : (this.config.playsinline = !0);
                                            }
